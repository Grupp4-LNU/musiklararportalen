				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="post-content">
						...
						<div class="entry">
							...
							<h2>Kategorier</h2>
							<?php 
								foreach(get_the_terms($post->ID, 'mlp_category') as $term) {
									echo $term->name;
								}  
								echo the_terms($post->ID, 'mlp_category');
							?>
							<h2>Årskurser</h2>
							<?php
								foreach(get_the_terms($post->ID, 'mlp_grade') as $term) {
									echo $term->name;
								}
								echo the_terms($post->ID, 'mlp_grade');  
							?>
